<?php
   ...
   $blog_readmore__icon = SASSLY_IMG .'/default-blog/icon-right-arrow.svg';
        ...
        <?php if(sassly_option('blog_readmore',1)): ?>
          <div class="cf_btn">
            <a href="<?php the_permalink(); ?>" class="wc-btn-underline">
                ...
                <?php echo esc_html(sassly_option('blog_readmore_text','Read more')); ?><?php echo sassly_kses($icon); ?></a>
          </div>
        <?php endif; ?>
    </div>
  </article>

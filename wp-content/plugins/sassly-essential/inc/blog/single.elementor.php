<?php 
  ...
  $args = array(
    ...
    'meta_key' => 'wcf_essential_settings_post_layoutactivate',
...
<div class="wcf-sing-tpl-wrapper">
    <h4><a class="wcf-post-layout-import-modal button button-primary csf--button" data-id="post_layout" href="javascript:void(0)"><?php echo esc_html__('Import From Library','sassly-essential') ?></a> </h4>

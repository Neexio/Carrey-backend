...
<div class="wcf-search-tpl-wrapper">
    <h4><a class="wcf-post-layout-import-modal button button-primary csf--button" data-id="search_layout" href="javascript:void(0)"><?php echo esc_html__('Import From Library','sassly-essential') ?></a> </h4>

...
class Skin_Portfolio_Seven extends Skin_Portfolio_Base {
	...
	public function get_title() {
		return __( 'Portfolio Seven', 'wcf-addons-pro' );
	}
	...
	public function register_controls( Widget_Base $widget ) {
		...
		$this->add_responsive_control(
			'thumb_slider_width',
			[
				'label'      => esc_html__( 'Thumb slider width', 'wcf-addons-pro' ),
		...
		$this->add_responsive_control(
			'thumb_slider_height',
			[
				'label'      => esc_html__( 'Thumb slider Height', 'wcf-addons-pro' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%', 'em', 'rem', 'vh', 'custom' ],
				'range'      => [
					'px' => [
		...
		$this->add_control( 'thumb_slider_direction',
			[
				'label'     => esc_html__( 'Thumb slider direction', 'wcf-addons-pro' ),
				'type'      => Controls_Manager::CHOOSE,
				'options'   => [
					'row-reverse' => [
						'title' => esc_html__( 'After', 'wcf-addons' ),
						'icon'  => 'eicon-h-align-left',
					],
					'row'         => [
						'title' => esc_html__( 'Before', 'wcf-addons' ),
		...
		$this->add_responsive_control(
			'icon_rotate',
			[
				'label'     => esc_html__( 'Rotate', 'wcf-addons-por' ),
				'type'      => Controls_Manager::SLIDER,
				'range'     => [
					'px' => [
						'min' => - 360,
	...
	protected function register_slider_controls( $default_value = [] ) {
		...
		$this->update_control(
			'slides_to_show',
			[
				'label'       => esc_html__( 'Thumb Slides to Show', 'wcf-addons-pro' ),
		...
		$this->add_responsive_control(
			'thumb_display',
			[
				'label'          => esc_html__( 'Thumb Slider Display', 'wcf-addons-pro' ),
				'type'           => Controls_Manager::SELECT,
				'separator'      => 'before',
				'default'        => 'block',
				'mobile_default' => 'none',
				'options'        => [
					'block' => esc_html__( 'Block', 'wcf-addons-pro' ),

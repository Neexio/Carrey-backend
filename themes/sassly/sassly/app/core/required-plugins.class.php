    ...
    public function get_plugin_config_data(){
        $plugins	 = array( 
            ...
            array(
                ...
                'required'	 => true,
                'source'     => SASSLY_THEME_DIR .'/app/third-party/animation-addons-for-elementor.zip', // The plugin source.
            ),
            
            array(
                'name'		 => esc_html__( 'Animation Addons for Elementor Pro', 'sassly' ),
                'slug'		 => 'animation-addons-for-elementor-pro',
                'required'	 => true,
                'source'     => SASSLY_THEME_DIR .'/app/third-party/animation-addons-for-elementor-pro.zip', // The plugin source.
            ),             

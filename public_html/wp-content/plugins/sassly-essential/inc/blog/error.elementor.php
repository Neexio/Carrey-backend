<?php 
  ...
  $args = array(
    'numberposts' => 4,
    'post_type' => ['wcf-error-tpl'],
    'post_status' => array('publish'),
    'meta_key' => 'wcf_essential_settings_error_layoutactivate',
    'orderby' => 'meta_value_num',
  );
  
  $latest_posts = get_posts( $args );
  $active_id = get_option('wcf-elementor-error-layout-id');
  
  $hf_page  = admin_url( 'edit.php?post_type=wcf-error-tpl' );
...
?>
<style>
.wcf-error-tpl-wrapper .wcf--blog-builder-list {
    display: flex;
    gap: 80px;
    flex-wrap: wrap;
}
...
<div class="wcf-error-tpl-wrapper">
    <h4><a class="wcf-post-layout-import-modal button button-primary csf--button" data-id="error_layout" href="javascript:void(0)"><?php echo esc_html__('Import From Library','sassly-essential') ?></a> </h4>

    ...
    var Wcf_User_Guilder = {
        init: function (settings) {
            ...
            Wcf_User_Guilder.config = {
                ...
                rating_link: 'https://themeforest.net/user/crowdytheme',
                update_link: ajax_object.update_path,
                banner_link: 'https://crowdytheme.com/assets/wp-content/uploads/2024/06/theme-preview.png',
                ...
                has_update: false,
                welcome_heading: 'Welcome to Sassly 1.3',
                welcome_desc: 'Sassly is a WordPress theme developed for various types of Sass Products, Software, Startups, App showcases, and SaaS-related services. It is fully responsive, speed-optimized,  and looks stunning on all types of screens and devices. You can utilize Sassly to present and promote your start-up SaaS applications, software, and other digital products.',
                _required_plugins: [
                    {
                        'slug': 'elementor', 'title': 'Elementor', 'remote-source': true
                    },
                    {
                        'slug': 'animation-addons-for-elementor', 'title': 'Animation Addons', 'remote-source': true
                    },
                    {
                        'slug': 'sassly-essential', 'title': 'Essential Plugin', 'remote-source': false
                    },
                    {
                        'slug': 'extension-for-animation-addons', 'title': 'WCF Extension', 'remote-source': false
                    },
                    {
        ...
        register_event_listners: function () {
            ...
            $(document).on('click', '#wcf--deactivate-ls', function () {
                ...
                if (confirm("Would you like to deactivate theme ?") == true) {
                    Wcf_User_Guilder.deactivate_theme_core_func(true);
                }
        ...
        theme_left_banner_update: function () {
            let html = ``;
            if (Wcf_User_Guilder.config.has_update) {
                html = `
        ...
        goto_thankyou_page: function (path) {
            ...
            <div class="wcf--license-step-three">
                ${thanks}
                <a href="${path}" class="wcf--license-default-btn wcf--theme-demo-button">Import demo</a>
                <a href="https://member.crowdytheme.com/" target="_blank" style="margin-left:12px" class="wcf--license-default-btn wcf--theme-demo-button">Manage License</a>
        ...
        deactivate_theme_core_func: function () {
            jQuery.ajax({
                type: "post",
                dataType: "json",
                url: ajax_object.ajaxurl,
        ...
        check_license_activation: function () {
            ...
            jQuery.ajax({
                ...
                data: {
                    ...
                    nonce: ajax_object.ajax_nonce,
                    ls_code: Wcf_User_Guilder.config.ls_code,
                    ls_email: Wcf_User_Guilder.config.ls_email,
                    ...
                    if (!response.code) {
                        let form = `
                            <div class="wcf-license-step-one">
                                ...
                                <div style="text-align:center; padding-bottom: 10px; color: #b32d2e;"> <b class="wcf-warning-message">${response.msg}</b> </div>
                                ...
                                <div class="el-license-field">
                                    ...
                                    <input type="text" class="regular-text code" name="el_license_email" size="50" value="${response.email}" placeholder="someone@gmail.com"required="required">
                                </div>
                                <div class="el-license-field">
                                    <label></label>                                

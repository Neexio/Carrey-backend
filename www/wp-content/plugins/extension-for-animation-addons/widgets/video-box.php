...
class Video_Box extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'WCF Video Box', 'extension-for-animation-addons' );
	}
	...
	public function get_style_depends() {
		return [ 'magnific-popup', 'wcf--video-box' ];
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'section_layout',
			[
				'label' => __( 'Layout', 'extension-for-animation-addons' ),
			]
		);
		...
		$this->add_control(
			'layout_style',
			[
				'label'   => esc_html__( 'Style', 'extension-for-animation-addons' ),
				'type'    => Controls_Manager::SELECT,
				'default' => '1',
				'options' => [
					'1' => esc_html__( 'Style One', 'extension-for-animation-addons' ),
					'2' => esc_html__( 'Style Two', 'extension-for-animation-addons' ),
				],
			]
		);
		...
		$this->add_control(
			...
			[
				'type'    => Controls_Manager::CHOOSE,
				'label'   => esc_html__( 'Type', 'extension-for-animation-addons' ),
				'default' => 'image',
				'options' => [
					'image' => [
						'title' => esc_html__( 'Image', 'extension-for-animation-addons' ),
						'icon'  => 'eicon-image-bold',
					],
					'video' => [
						'title' => esc_html__( 'Video', 'extension-for-animation-addons' ),
		...
		$this->add_control(
			'image',
			[
				'label'     => esc_html__( 'Image', 'extension-for-animation-addons' ),
		...
		$this->add_control(
			'video',
			[
				'label'       => esc_html__( 'Video', 'extension-for-animation-addons' ),
				'type'        => Controls_Manager::MEDIA,
				'media_types' => [ 'video' ],
				'default'     => [
					'url' => Utils::get_placeholder_image_src(),
		...
		$this->start_controls_section(
			'section_box_style',
			[
				'label' => __( 'Video Box', 'extension-for-animation-addons' ),
	...
	protected function register_content_controls() {
		...
		$this->add_responsive_control(
			'title_space',
			[
				'label'      => esc_html__( 'Space', 'extension-for-animation-addons' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', 'em', 'rem' ],
				'range'      => [
					'px' => [

...
class Video_Box_Slider extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'WCF Video Box Slider', 'extension-for-animation-addons' );
	}
	...
	public function get_script_depends() {
		return [ 'swiper', 'magnific-popup', 'wcf--slider'];
	}
	...
	public function get_style_depends() {
		return [  'magnific-popup', 'wcf--video-box-slider' ];
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_content',
			[
				'label' => __( 'Video Box Slider', 'extension-for-animation-addons' ),
			]
		);
		...
		$repeater->add_control(
			...
			[
				...
				'default'     => esc_html__( 'Adam Smith', 'extension-for-animation-addons' ),
		...
		$repeater->add_control(
			...
			[
				...
				'type'        => Controls_Manager::TEXT,
				'default'     => esc_html__( 'Developer', 'extension-for-animation-addons' ),
		...
		$this->add_control(
			'video_slides',
			[
				'label'   => esc_html__( 'Video Slides', 'extension-for-animation-addons' ),
		...
		$this->add_control(
			'title_tag',
			[
				'label'     => esc_html__( 'Title HTML Tag', 'extension-for-animation-addons' ),
		...
		$this->add_control(
			'show_thumb_after',
			[
				'label'        => esc_html__( 'Thumbnail After', 'extension-for-animation-addons' ),
				'description'  => esc_html__( 'This settings for creating shape behind the thumbnail, Please enable the settings and use the style part for crating shape.', 'extension-for-animation-addons' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__( 'Show', 'extension-for-animation-addons' ),
				'label_off'    => esc_html__( 'Hide', 'extension-for-animation-addons' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'thumb_after_display',
			[
				'label'        => esc_html__( 'Display', 'extension-for-animation-addons' ),
				'type'         => Controls_Manager::SELECT,
				'default'      => '',
				'options'      => [
					''                => esc_html__( 'Default', 'extension-for-animation-addons' ),
					'hover-slide'  => esc_html__( 'On Hover Slide', 'extension-for-animation-addons' ),
					'active-slide' => esc_html__( 'On Active Slide', 'extension-for-animation-addons' ),
				],
		...
		$this->add_responsive_control(
			'slider_width',
			[
				'label'      => esc_html__( 'Slider Max Width', 'extension-for-animation-addons' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Slider Options', 'extension-for-animation-addons' ),
			]
		);
		...
		$this->add_control(
			'center_slide',
			[
				'label'        => esc_html__( 'Center Slide', 'extension-for-animation-addons' ),
				'type'         => Controls_Manager::SWITCHER,
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'slide Scale', 'extension-for-animation-addons' ),
		...
		$this->add_control(
			'slide_scale_x',
			[
				'label'     => esc_html__( 'Slide Scale X', 'extension-for-animation-addons' ),
				'type'      => Controls_Manager::SLIDER,
				'range'     => [
					'px' => [
						'max'  => 1,
		...
		$this->add_control(
			'slide_scale_y',
			[
				'label'     => esc_html__( 'Slide Scale Y', 'extension-for-animation-addons' ),
				'type'      => Controls_Manager::SLIDER,
				'range'     => [
					'px' => [
						'max'  => 1,
		...
		$this->start_controls_section(
			'section_thumb_style',
			[
				'label' => __( 'Thumbnail', 'extension-for-animation-addons' ),
		...
		$this->add_control(
			'image_padding',
			[
				'label'      => esc_html__( 'Padding', 'extension-for-animation-addons' ),
		...
		$this->start_controls_section(
			...
			[
				'label'     => __( 'Thumbnail After', 'extension-for-animation-addons' ),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => [ 'show_thumb_after' => 'yes' ]
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Content', 'extension-for-animation-addons' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			'title_color',
			[
				'label'     => esc_html__( 'Title Color', 'extension-for-animation-addons' ),
		...
		$this->add_control(
			'title_margin',
			[
				'label'      => esc_html__( 'Margin', 'extension-for-animation-addons' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em', 'rem', ],
				'selectors'  => [
		...
		$this->add_control(
			'subtitle_color',
			[
				'label'     => esc_html__( 'Color', 'extension-for-animation-addons' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label'     => esc_html__( 'Slider Navigation', 'extension-for-animation-addons' ),
				'tab'       => Controls_Manager::TAB_STYLE,
		...
		$this->start_controls_section(
			...
			[
				'label'     => esc_html__( 'Slider Pagination', 'extension-for-animation-addons' ),
				'tab'       => Controls_Manager::TAB_STYLE,
	...
	protected function render_popup_button( $settings, $index, $item ) {
		...
		if ( ! empty( $item['video_link'] ) ) {
			$this->add_render_attribute( $link_key, 'href', $item['video_link'] );
		} else {

...
class Author_Box extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'WCF Author Box', 'wcf-addons-pro' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_author_info',
			[
				'label' => esc_html__( 'Author Info', 'wcf-addons-pro' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => 'current',
				'options' => [
					'current' => esc_html__( 'Current Author', 'wcf-addons-pro' ),
		...
		$this->add_control(
			'show_avatar',
			[
				'label'        => esc_html__( 'Profile Picture', 'wcf-addons-pro' ),
		...
		$this->add_control(
			'avatar_size',
			[
				'label'     => esc_html__( 'Picture Size', 'wcf-addons-pro' ),
		...
		$this->add_control(
			'show_name',
			[
				'label'        => esc_html__( 'Display Name', 'wcf-addons-pro' ),
				'type'         => Controls_Manager::SWITCHER,
		...
		$this->add_control(
			...
			[
				...
				'default'   => esc_html__( 'John Doe', 'wcf-addons-pro' ),
				'condition' => [
					'source' => 'custom',
				],
				'separator' => 'before',
		...
		$this->add_control(
			...
			[
				...
				'options'     => [
					...
					'website'       => esc_html__( 'Website', 'wcf-addons-pro' ),
					'posts_archive' => esc_html__( 'Posts Archive', 'wcf-addons-pro' ),
				],
				'condition'   => [
					'source!' => 'custom',
				],
				'description' => esc_html__( 'Link for the Author Name and Image', 'wcf-addons-pro' ),
			]
		);
		...
		$this->add_control(
			'show_biography',
			[
				'label'        => esc_html__( 'Biography', 'wcf-addons-pro' ),
				'type'         => Controls_Manager::SWITCHER,
		...
		$this->add_control(
			'show_link',
			[
				'label'        => esc_html__( 'Archive Button', 'wcf-addons-pro' ),
				'type'         => Controls_Manager::SWITCHER,
		...
		$this->add_control(
			...
			[
				...
				'default'   => esc_html__( 'Lorem ipsum dolor sit amet consectetur adipiscing elit dolor', 'wcf-addons-pro' ),
				'rows'      => 3,
				'condition' => [
					'source' => 'custom',
				],
		...
		$this->add_control(
			'link_text',
			[
				'label'   => esc_html__( 'Archive Text', 'wcf-addons-pro' ),
				'type'    => Controls_Manager::TEXT,
				'default' => esc_html__( 'All Posts', 'wcf-addons-pro' ),
				'dynamic' => [
					'active' => true,
				],
			]
		...
		$this->add_responsive_control(
			'image_size',
			[
				'label'      => esc_html__( 'Image Size', 'wcf-addons-pro' ),
		...
		$this->add_control(
			'image_border',
			[
				'label'     => esc_html__( 'Border', 'wcf-addons-pro' ),
				'type'      => Controls_Manager::SWITCHER,
				'selectors' => [
		...
		if ( $print_avatar ) {
			$this->add_render_attribute(
				...
				[
					...
					'alt'     => ( ! empty( $author['display_name'] ) ) ? $author['display_name'] : esc_html__( 'Author picture', 'wcf-addons-pro' ),
					'loading' => 'lazy',
				]
			);
		}

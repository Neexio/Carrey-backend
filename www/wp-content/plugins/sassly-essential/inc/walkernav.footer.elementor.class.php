...
class WCF_Walker_Elementor_Footer_Nav extends Walker_Nav_Menu
{
/**
    ...
    public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
        ...
        if($this->elementor_settings['icon_left'] === false){
            $item_output .= $args->link_before . apply_filters( 'the_title', $item->title, $item->ID ) . $args->link_after;
        }
        if ( $this->elementor_settings['has_dropdown_arrow_icon'] && $depth === 0) {
            $item_output .= \SasslyEssentialApp\Inc\Iinherit\Wcf_Icon_Manager::render_icon( $this->elementor_settings['menu_down_icon'] );
        }
        
        if($this->elementor_settings['icon_left'] === true){
            $item_output .= $args->link_before . apply_filters( 'the_title', $item->title, $item->ID ) . $args->link_after;
        }

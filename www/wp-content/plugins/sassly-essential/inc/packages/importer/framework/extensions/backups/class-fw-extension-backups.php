	...
	public function _action_admin_notices_litespeed() {
		...
		echo
			'<div class="notice notice-warning">
				<p><strong>Demo Importer: </strong>' .
					sprintf(
						esc_html__( 'If you face issue with demo content importer. Please click on this link %sarticle%s to fix it', 'fw' ),
						'<a href="'. esc_attr(admin_url('admin.php?page=wcf-theme-demo-import')) .'" target="_blank">',
						'</a>'
					) .
				'</p>
		...
		do {
			 ...
			 */
			{
				$output_buffer_size = max(
					//  /issues/2070#issuecomment-258427852
